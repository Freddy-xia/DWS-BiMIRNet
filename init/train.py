...
parser.add_argument('--train_dir', default='/root/autodl-tmp/NeRD-Rain-main/Datasets/sand/train/', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='/root/autodl-tmp/NeRD-Rain-main/Datasets/sand/test/', type=str, help='Directory of validation images')
parser.add_argument('--model_save_dir', default='/root/autodl-tmp/NeRD-Rain-main/checkpoints/', type=str, help='Path to save weights')
...
for epoch in range(start_epoch, num_epochs + 1):
    ...
    for i, data in enumerate(tqdm(train_loader), 0):
        ...
        loss = loss_char + 0.01 * loss_fft + 0.05 * loss_edge + 0.1 * loss_l1 + lambda_dtcwt * loss_dtcwt
        loss.backward()
        optimizer.step()
