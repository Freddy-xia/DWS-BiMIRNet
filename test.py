...
parser.add_argument('--input_dir', default='F:\\NeRD-Rain-main\Datasets\\Rain200L\\test\input', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./results/Rain200L_all', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='F:\\NeRD-Rain-main\checkpoints\\rain200L_all\model_epoch_300.pth', type=str, help='Path to weights')
